 ...
 */
export type PrimaryOnboardingGoal = 'save_time' | 'save_money' | 'health' | null;

export interface UserObjectives {
  primaryGoal: PrimaryOnboardingGoal;
  weeklySavingsTarget?: number | null;
  calorieTarget?: number | null;
  householdBudget?: number | null;
}

export interface UserPreferences {
  // Preferencias culinarias y restricciones
  ...
  // Compatibilidad legacy (mantener mientras se depuran componentes antiguos)
