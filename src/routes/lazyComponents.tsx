...
export const LazyLandingComponents = {
  ...
  VisualCatalogue: lazy(() => import('../components/sections/VisualCatalogue')),
  Testimonials: lazy(() => import('../components/sections/Testimonials')),
  DemoCTA: lazy(() => import('../components/sections/DemoCTA')),
...
export const LazyFeatures = {
  ...
  PlanningPage: lazy(() => import('../features/planning/PlanningPage').catch(error => {
    console.error('Error loading PlanningPage:', error);
    throw error;
  })),
  OnboardingPage: lazy(() => import('../features/onboarding/OnboardingPage')),
